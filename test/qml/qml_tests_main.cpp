...
class MockNodeModel : public QObject
{
    ...
    Q_PROPERTY(QString runtimeDialogPrimaryText MEMBER m_runtime_dialog_primary_text NOTIFY runtimeDialogChanged)
    Q_PROPERTY(QString runtimeDialogSecondaryText MEMBER m_runtime_dialog_secondary_text NOTIFY runtimeDialogChanged)
...
public:
    ...
    QString m_runtime_dialog_primary_text{QStringLiteral("OK")};
    ...
    Q_INVOKABLE void answerRuntimeDialog(bool accepted)
    {
        Q_UNUSED(accepted);
    ...
    Q_INVOKABLE void setRuntimeDialogForTest(const QString& title, const QString& message, bool question)
    {
        ...
        m_runtime_dialog_primary_text = question ? QStringLiteral("Yes") : QStringLiteral("OK");
        m_runtime_dialog_secondary_text = question ? QStringLiteral("No") : QString{};
