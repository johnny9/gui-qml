...
#ifndef BITCOIN_QML_WALLET_RECEIVEREQUESTHISTORYMODEL_H
#define BITCOIN_QML_WALLET_RECEIVEREQUESTHISTORYMODEL_H
...
public:
    ...
    int64_t maxId() const;
    const std::vector<QmlRecentRequestEntry>& entries() const { return m_entries; }
...
#endif // BITCOIN_QML_WALLET_RECEIVEREQUESTHISTORYMODEL_H
